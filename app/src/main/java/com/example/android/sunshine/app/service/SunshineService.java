...
/**
 * Created by Cencil on 9/19/2015.
 */
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getStringExtra(LOCATION_QUERY_EXTRA) == null) {
            Log.d(LOG_TAG, "intent.getDataString is null!");
            return;
        }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            Uri insertUri = getBaseContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, locationValues);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = getBaseContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cvArray);
            }
