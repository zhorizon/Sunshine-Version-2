...
public class MainActivity extends ActionBarActivity implements ForecastFragment.Callback {
    ...
    public static final String PROJECT_NUMBER = "172470301674";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    ...
                    msg = "Service registered, registration ID=" + regId;
                    ...
                    // will send upstream messages toa server that echo back the
